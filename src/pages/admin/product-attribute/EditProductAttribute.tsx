...
import FormCreateProductAttribute from "../../../components/forms/admin/FormCreateProductAttribute";
...
const EditProductAttribute = () => {
  const item: BreadcrumbItemType[] = [
    ...
    {
      title: <Link to="/admin/product-attribute">product-attribute</Link>,
    },
    {
      title: "edit",
    },
    ...
    <>
      <div className="p-4">
        ...
        <div className="bg-white rounded-lg mt-4 p-4">
          <span className="font-medium">Edit Product Attribute Form</span>
          {id && <FormCreateProductAttribute id={Number(id)} />}
        </div>
      </div>
    </>
  );
